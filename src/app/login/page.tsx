      ...
      <main className="bg-blur-lg flex min-h-[100dvh] w-full">
        <div className="flex flex-1 flex-col items-center justify-center bg-[#f5f5f5] px-6 py-12 sm:px-10 md:flex-row md:px-16 lg:px-20 xl:px-24 dark:bg-[#1a1a1a]">
          ...
          <article className="mt-10 flex w-full max-w-md flex-col space-y-8 rounded-lg bg-white p-6 shadow-lg md:mt-0 dark:bg-[#222]">
            ...
            <section className="flex flex-col items-center justify-between space-x-4">
              <div className="flex w-full items-center justify-between space-x-4">
                <div className="h-10 w-10 rounded-full bg-[#f5f5f5] dark:bg-[#222]">
                  {!user || !isLoaded ? (
                    <div className="flex items-center space-x-4">
                      <div className="flex h-full w-full items-center justify-center rounded-full">
                        <div className="h-10 w-10 animate-pulse rounded-full bg-neutral-600 dark:bg-neutral-200"></div>
                      </div>

                      <div className="flex flex-col">
                        <div className="mb-2 h-4 w-24 animate-pulse rounded-md bg-neutral-600 dark:bg-neutral-200"></div>
                        <div className="h-4 w-16 animate-pulse rounded-md bg-neutral-600 dark:bg-neutral-200"></div>
                      </div>
                    </div>
                  ) : user.imageUrl ? (
                    <img
                    ...
                    <div className="flex h-full w-full items-center justify-center rounded-full bg-neutral-200 text-xl font-semibold dark:bg-neutral-600">
                ...
                <button
                  className="btn btn-primary flex-grow-0 text-nowrap"
              ...
              <div className="flex w-full flex-col">
                <hr className="my-4 w-full border-neutral-600 dark:border-neutral-200" />
